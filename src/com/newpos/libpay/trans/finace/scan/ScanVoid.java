...
public class ScanVoid extends FinanceTrans implements TransPresenter{
    ...
    public ScanVoid(Context ctx, String transEname  , TransInputPara para) {
                ...
                if(info.isResultFlag()){
                    ...
                    if(data!=null && !data.getIsVoided() && data.getEName().equals(Type.SCANSALE)){
                        ...
                        if(0 == retVal){
                            ...
                            if(retVal == 0){
                                data.setVoided(true);
                                transUI.trannSuccess(timeout , Tcode.Status.scan_void_success ,
