...
public class ISOUtil {
     ...
     * @throws ISOException if string's length greater than len
     */
    public static String spacepad(String s, int len) {
        if (s==null)
            s = "";
     ...
     * @throws ISOException if string's length greater than len
     */
    public static String spacepadZero(String s, int len) {
        if (s==null)
            s = "";
        return padleft(s, len, '0');
    }
     ...
     * @throws ISOException if string's length greater than len
     */
    public static String spacepadRight(String s, int len) {
        if (s==null)
            s = "";
    ...
    public static String hexString1(byte[] b) {
        String valueHex = "";
        int hi = 0;
        int lo = 0;
