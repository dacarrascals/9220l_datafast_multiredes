...
public class TransPagosVarios extends FinanceTrans implements TransPresenter {
    ...
    public void start() {
        ...
        if (procesarPagosVarios()==0){
            transUI.trannSuccess(timeout, Tcode.Status.pago_vario_succ);
    ...
    public void isICC() {
        ...
        if (retVal == 1 || retVal == 0) {
            ...
            //No AID
            //retVal = CommonFunctionalities.contFallback(retVal);
            transUI.showError(timeout, retVal);
        }
    }
                ...
                if (typeCoin != null) {
                    switch (typeCoin) {
                        case DOLAR:
                            ...
                            transUI.trannSuccess(timeout, Tcode.Status.pago_vario_succ,"APROBADA #" + authCode);
                            break;
                    }
                } else {
                    transUI.trannSuccess(timeout, Tcode.Status.pago_vario_succ, "");
